...
const Features = () => {
	...
	return (
		<div
			id='features'
			className='w-full flex flex-col items-center mb-48 px-4 scroll-mt-12'
		>
...
<Title title='Build your resume' description='Our streamlined process helps you create a professional resume in minutes with intelligent AI-powered tools and features.'/>
			...
			<div className='w-full max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-10 xl:-mt-10'>
				<img
					className='w-full max-w-xl lg:w-1/2 lg:max-w-2xl'
				...
				>
					<div
						className={
							'flex items-center justify-center gap-6 w-full group cursor-pointer'
						}
					>
						<div
					...
					<div className='flex items-center justify-center gap-6 w-full group cursor-pointer'>
