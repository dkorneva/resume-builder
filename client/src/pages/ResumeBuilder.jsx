  ...
  useEffect(() => {
	...
	const saveResume = async () => {
		try {
			...
			let payload = { resumeId, resumeData: updatedResumeData }

			if (hasNewImage) {
				payload = new FormData()
				payload.append("resumeId", resumeId)
				payload.append("resumeData", JSON.stringify(updatedResumeData))
				removeBackground && payload.append("removeBackground", "yes")
				payload.append("image", resumeData.personal_info.image)
			}
